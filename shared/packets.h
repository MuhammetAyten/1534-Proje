...
#define WIZ_PACKET5				0x74 //s�reli item
...
#define WIZ_HACKSHIELD_GUARD	0xA1	// HackShield Guard
...
enum ClanNameChangeOpcode
{
	ClanNameChangePlayerRequest	= 16, // contains the request with the player's clan name
	ClanNameChangeShowDialog	= 1,
	ClanNameChangeInvalidName	= 2,
	ClanNameChangeSuccess		= 3,
	ClanNameChangeInClan		= 4
};
...
enum KingSystemDBOpcodes
{
	KING_ELECTION_UPDATE_STATUS,
	KING_ELECTION_UPDATE_LIST,
	KING_ELECTION_VOTE,
	KING_ELECTION_GET_VOTE_RESULTS
};
...
enum MiningSystemOpcodes
{
	...
	// Fish Every n seconds, calls this packet to see if they found anything.
	FishingAttempt	= 7,

	// Fish the mining process
	FishingStop		= 8,
...
enum MiningErrors
{
	...
	MiningResultNoEarthWorm		= 7, // "No Earthworm"
};

#define MINING_DELAY			2 // seconds
...
enum
{
	...
	KNIGHTS_USER_ONLINE     = 0x27,
	KNIGHTS_USER_OFFLINE    = 0x28,
	...
	KNIGHTS_UPDATE_USER		= 0xF2,
	KNIGHTS_UPDATE_CAPE		= 0xF3,
	KNIGHTS_SAVE			= 0xF4
};
...
enum EventTimeCode
{
	TEMPLE_EVENT_BORDER_TIME		= 1801,
	TEMPLE_EVENT_CHAOS_TIME			= 1201,
	TEMPLE_EVENT_JURAID_TIME		= 2401,
	QUEST_EVENT_MONSTER_STONE_TIME	= 1801
};
...
////////////////////////////////////////////////////////////////
//VIPINN Packet sub define
////////////////////////////////////////////////////////////////
#define VIPHOUSE_OPEN			0x01
#define VIPHOUSE_INPUT			0x02
#define VIPHOUSE_OUTPUT			0x03
#define VIPHOUSE_MOVE			0x04
#define VIPHOUSE_INVEN_MOVE		0x05
#define VIPHOUSE_IMPUT_KEY		0X06
#define VIPHOUSE_KEY_EXPIRE		0X07
#define VIPHOUSE_PASS_SET		0X08
#define VIPHOUSE_PASS_CANCEL	0X09
#define VIPHOUSE_PASS_CHANGE	0x0A
#define VIPHOUSE_PASS_REQ		0x0B
...
/**
* @brief	Includes all upgrade related enumarations.
*			Note that seal/unseal, some exchanges are also
*			handled with this type of packet.
*/
enum ItemUpgradeOpcodes
{
	...
	ITEM_OLDMAN_EXCHANGE	= 13,
};

/**
* @brief	Includes all upgrade related error enumarations.
*/
...
/**
* @brief	Includes all scroll types used during the upgrate related enumarations.
*/
enum UpgradeScrollType
{
	InvalidScroll = -1,
	LowClassScroll = 1,
	MiddleClassScroll = 2,
	HighClassScroll = 3,
	RebirthClassScroll = 4,
	HighToRebirthScroll = 15,
	AccessoriesClassScroll = 8
};

/**
* @brief	Includes all upgrade type enumarations.
*/
enum UpgradeType 
{ 
	UpgradeTypeNormal = 1,
	UpgradeTypePreview = 2 
};

struct ITEM_UPGRADE_ITEM
{
	int32 nItemID;
	int8 bPos;
};

typedef std::map<uint8,ITEM_UPGRADE_ITEM> UpgradeItemsMap;
typedef std::map<uint8,ITEM_UPGRADE_ITEM>::iterator UpgradeIterator;
...
enum VIPStorageOpcodes
{
	VIP_Open = 1,
	VIP_InvenToStorage = 2,
	VIP_StorageToInven = 3,
	VIP_StorageToStore = 4,
	VIP_InvenToInven = 5,
	VIP_UseVault = 6,
	VIP_Expired = 7,
	VIP_SetPassword = 8,
	VIP_CancelPassword = 9,
	VIP_ChangePassword = 10,
	VIP_EnterPassword = 11
};
...
enum ObjectType
{
	...
	OBJECT_ARTIFACT		= 9,
	OBJECT_NPC			= 11,
	OBJECT_KROWASGATE	= 12,
	OBJECT_POISONGAS	= 13,
	OBJECT_WOOD			= 14,
	OBJECT_WOOD_LEVER	= 15,
	OBJECT_EFECKT		= 50
};
