...
public:
	...
	//----------------------------------------------------------------
	uint8	m_tNpcAttType;
	uint8	m_NpcOldActType; //DuslerinSokagi
	uint8	m_NpcGroupType;  //DuslerinSokagi // When set, monsters behave in groups (defined by their family type) and will seek out help from nearby similar mobs.
	uint8	m_NpcEndActType; //DuslerinSokagi
	uint8	m_byAttackPos;	// User
	uint8	m_byBattlePos;
	bool	m_byGateOpen;	// Gate Npc Status -> 1 : open 0 : close
