...
public:
	...
	CGameSocket(uint16 socketID, SocketMgr *mgr) : KOSocket(socketID, mgr, -1, 662144, 331072) {}
	...
	void RecvNpcUpdateInfo(Packet & pkt);
	bool SetUid(float x, float z, int id, uint8 type, int speed);
