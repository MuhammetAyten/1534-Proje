...
typedef CSTLMap <_MINING_ITEM>						MiningItemArray;
typedef CSTLMap <_FISHING_ITEM>						FishingItemArray;
typedef CSTLMap <_TEMPLE_EVENT_USER>				TempleEventUserArray;
typedef CSTLMap <_TEMPLE_QUEST_EVENT_USER>			TempleQuestEventUserArray;
...
typedef CSTLMap <_USER_SEAL>						UserSealItemArray;