...
#include "../shared/database/UserSealSet.h"
...
#include "../shared/database/MiningTableSet.h"
#include "../shared/database/FishingTableSet.h"
...
bool CGameServerDlg::LoadUserSealTable()
{
	LOAD_TABLE(CIUserSealItem, g_DBAgent.m_GameDB, &m_UserSealItemArray, true, false);
}
...
bool CGameServerDlg::LoadMiningItemTable()
{
	LOAD_TABLE(CMiningTableSet, g_DBAgent.m_GameDB, &m_MiningItemArray, true, false);
}

bool CGameServerDlg::LoadFishingItemTable()
{
	LOAD_TABLE(CFishingTableSet, g_DBAgent.m_GameDB, &m_FishingItemArray, true, false);
}
