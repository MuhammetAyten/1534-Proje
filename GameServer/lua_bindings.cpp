...
DEFINE_LUA_CLASS
	...
	MAKE_LUA_METHOD(GetQuestStatus)
	...
	MAKE_LUA_METHOD(GiveCash)
	MAKE_LUA_METHOD(TempleOperations)
	MAKE_LUA_METHOD(ShowBulletinBoard)
	...
	MAKE_LUA_METHOD(SendClanNameChange)
	...
	MAKE_LUA_METHOD(GetPremiumTime)
	...
	MAKE_LUA_METHOD(GiveKnightCash)
	...
	MAKE_LUA_METHOD(EventSoccerMember)
	MAKE_LUA_METHOD(EventSoccerStard)
	MAKE_LUA_METHOD(SpawnEventSystem)
	);
#undef LUA_CLASS
...
LUA_WRAPPER_USER_FUNCTION(GetQuestStatus);
...
LUA_WRAPPER_USER_FUNCTION(TempleOperations);
LUA_WRAPPER_USER_FUNCTION(ShowBulletinBoard);
...
LUA_WRAPPER_USER_FUNCTION(GetPremiumTime);
...
LUA_WRAPPER_USER_FUNCTION(EventSoccerMember);
LUA_WRAPPER_USER_FUNCTION(EventSoccerStard);
LUA_WRAPPER_USER_FUNCTION(SpawnEventSystem);
